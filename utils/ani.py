...
class HyperDatasetTest2(udata.Dataset):
    def __init__(self, mode='test'):
        if mode != 'test':
            raise Exception("Invalid mode!", mode)
        data_path = '/media/omnisky/c91e9985-5113-463d-83a6-6ec3405ef3a7/XZL/IR_SCI-TV-FFDNet-main/test_data/4'
        data_names = glob.glob(os.path.join(data_path, '*.bmp'))
