...
def run():
    ...
    for t, ms in enumerate(test_loader):
        ...
        cv2.imwrite("test_out/orig1033.bmp",ms)
        Rec_ffdnet = Rec_ffdnet * 255.0
        cv2.imwrite("test_out/Rec1033.bmp",Rec_ffdnet)
